  ...
  `;
    ...
    return (
        <>
            ...
            <div>
                <h2 style={{ textAlign: 'center', fontSize: "40px", fontWeight: "600" }}>Sign in to Harvest ID</h2>
            </div>

            <div styles={{ marginTop: "-500px" }} className={style.singinForm}>
                <div style={{ marginTop: "-50px", backgroundColor: "#FFF8F1", border: '1px solid orange' }} className={style.signin_card}>
                    ...
                    <a style={{ textDecoration: 'none' }} href="https://accounts.google.com/o/oauth2/auth/oauthchooseaccount?client_id=500745565949-k6idj8rm783v69v80gohems7j0ttit9n.apps.googleusercontent.com&login_hint&redirect_uri=https%3A%2F%2Fid.getharvest.com%2Fgoogle%2Foauth2%2Fcallback&response_type=code&scope=profile%20email&state=%7B%22intent%22%3A%22sign-in%22%2C%22authenticity_token%22%3A%22blVRmMsH--6a56U5iEJnvFbihZzNnkwhI1Hh7nRPH-je6weC1bm8-S14R9QFSpgxHYbrb7EQKORHN_pAr_A-EA%22%7D&flowName=GeneralOAuthFlow"> <div style={{ backgroundColor: "white", display: 'flex', border: '1px solid black', borderRadius: "20px" }}>
                        ...
                        <p onClick={googleauth} style={{ textAlign: "left", marginLeft: "70px", textDecoration: "none", color: "black" }} href="/google/oauth2/new?state%5Bintent%5D=sign-in">
                            Sign in with Google
                        </p>
                    </div></a>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <h5> or with your email below </h5>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <Button style={{ cursor: 'pointer', backgroundColor: "#11742A", borderRadius: "10px", color: "white" }}>Sign In</Button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div style={{ marginTop: "40px", margin: 'auto', width: "25%", display: "flex", gap: "20px" }}>
                    <a style={{ textDecoration: "none", color: "gray" }} href="https://id.getharvest.com/password_reset/new">Forgot password?</a>
                    <a style={{ textDecoration: "none", color: "gray" }} href="https://www.getharvest.com/terms-of-service">Terms of service Privacy</a>
                    <a style={{ textDecoration: "none", color: "gray" }} href="https://www.getharvest.com/privacy-policy"> policy</a>
                </div>
            </div>
        </>
    );
